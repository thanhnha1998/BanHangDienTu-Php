...
<body id="page-top" style="background-image: url(http://cdn.shopify.com/s/files/1/1337/0881/products/LMTPV300D-7A-600-x-600_grande.jpg?v=1487925495);">
  ...
  <div id="wrapper">
   ...
   <form action="themspdoi.php" method="POST">
...
$sql = "INSERT INTO couple VALUES ('".$_POST['user']."','".$_POST['name']."','".$_POST['img']."','".$_POST['gia']."','".$_POST['noidung']."')";
$stmt= $conn->query($sql);
}
?>
      </div>
